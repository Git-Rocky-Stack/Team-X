...
- `0001_*.sql` through `0035_*.sql` — Phase 2–6 additions (vault, RAG, command
  history, copilot, routines, budgets, approvals, artifacts, memory,
  runtime profiles/sessions, agent wakeups, schedule items, run/event trace ids)
