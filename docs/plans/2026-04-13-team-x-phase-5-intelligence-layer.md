...
**Shipped so far:** +416 unit tests (M28 + M29 + M30 + M31 + M32 T0–T8) + 4 E2E specs. Project totals as of M32 T9: **1033 unit tests / 8 E2E specs**, from the Phase 4 baseline of 612 / 4.
